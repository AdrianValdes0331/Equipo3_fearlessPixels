...
public class MultiplayerDmgPercent : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        ...
        {
            //DmgManager.instance.updateDmgPercentTxt("10%", "P1");
        } else if (nickname.Equals("Player 2"))
        {
            //DmgManager.instance.updateDmgPercentTxt("20%", "P2");
        ...
        {
            //DmgManager.instance.updateDmgPercentTxt("30%", "P3");
        ...
        {
            //DmgManager.instance.updateDmgPercentTxt("40%", "P4");
